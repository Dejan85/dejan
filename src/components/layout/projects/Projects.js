				...
				<div className="projects__grid--row">
					<div className="projects__grid--columns">
						<div
							...
							style={{ backgroundImage: `url(${projects && projects[0].image})` }}
						>
							<Link
								to={`/projects/${projects && projects[0].id}`}
								className="projects__grid--columns--child--content"
							>
								<h5 className="projects__grid--h5">{projects && projects[0].name}</h5>
					...
					<div className="projects__grid--columns2">
						<div
							...
							style={{ backgroundImage: `url(${projects && projects[1].image})` }}
						>
							<Link
								to={`/projects/${projects && projects[1].id}`}
								className="projects__grid--columns--child--content"
							>
								<h5 className="projects__grid--h5">{projects && projects[1].name}</h5>
								<p className="projects__grid--p">Read more</p>
							</Link>
						</div>
						<div
							className="projects__grid--columns2--child2"
							style={{ backgroundImage: `url(${projects && projects[2].image})` }}
						>
							<Link
								to={`/projects/${projects && projects[2].id}`}
								className="projects__grid--columns--child--content"
							>
								<h5 className="projects__grid--h5">{projects && projects[2].name}</h5>
								<p className="projects__grid--p">Read more</p>
							</Link>
						</div>
					</div>
				...
				<div className="projects__grid--row2">
					<div className="projects__grid--columns3">
						<div
							...
							style={{ backgroundImage: `url(${projects && projects[3].image})` }}
						>
							<Link to={`/projects/luckgame`} className="projects__grid--columns--child--content">
								<h5 className="projects__grid--h5">{projects && projects[3].name}</h5>
								<p className="projects__grid--p">Read more</p>
							</Link>
						</div>
					</div>
