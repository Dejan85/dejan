...
const SinglePost = ({ projects }) => {
	...
	return (
		<div className="singlePost" style={{ background: `url(${content && content.image})` }}>
			{/* {scrollIndicator()} */}
			<div className="singlePost__container">
				<div className="singlePost__content">
					<div className="singlePost__header">
						<h1 className="singlePost__h1" style={{ background: content && content.color }}>
						...
						<div className="singlePost__right">
							...
							<div className="singlePost__git">
								...
								<a
									...
									rel="noopener noreferrer"
								>
									{(window.opr && <i className="fab fa-opera singlePost__git--icon" />) ||
									(window.chrome && <i className="fab fa-chrome singlePost__git--icon" />) ||
			...
			{imageFullscreen && <ImageFullscreen fullscreenImage={fullscreenImage} imgSrc={imgSrc} />}
		</div>
	);
};
