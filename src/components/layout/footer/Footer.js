				...
				<div className="footer__content">
					<div className="footer__boxContainer">
						<div className="footer__box">
							...
							<p className="footer__p">
								...
								there live the blind texts. Far far away, behind the word mountains, far from the
						...
						<div className="footer__box" style={{ padding: '0 0 0 7rem' }}>
							...
							<ul className="footer__ul">
								<li className="footer__li">
									...
									<Link className="footer__link" to="home" spy={true} smooth={'true'} offset={-150}>
										Home
									</Link>
								</li>
								<li className="footer__li">
									<i className="fas fa-long-arrow-alt-right" />
									<Link className="footer__link" to="about" spy={true} smooth={'true'} offset={-150}>
										About
									</Link>
								</li>
								<li className="footer__li">
									<i className="fas fa-long-arrow-alt-right" />
									<Link className="footer__link" to="skills" spy={true} smooth={'true'} offset={-150}>
										Skills
									</Link>
								</li>
								<li className="footer__li">
								...
								{/* <li className="footer__li">
									<i className="fas fa-long-arrow-alt-right" />
									<Link className="footer__link" to="blog" spy={true} smooth={'true'} offset={-150}>
										Blog
									</Link>
								</li>
								<li className="footer__li">
					...
					<div className="footer__boxContainer">
						...
						<div className="footer__box2">
							...
							<ul className="footer__ul">
								<li className="footer__li">
									<i className="fas fa-envelope footer__icon" />xypnotica@gmail.com
								</li>
								<li className="footer__li">
									<i className="fas fa-phone  footer__icon" /> 069/1907978
								</li>
								<li className="footer__li">
									<i className="fab fa-viber  footer__icon" />069/1907978
								</li>
								<li className="footer__li">
									<i className="fab fa-github  footer__icon" />Github
								</li>
							</ul>
						</div>
					</div>
